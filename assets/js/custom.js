...
App.setup = function () {
  ...
  canvas.id = "mainbackgroundcanvas";
  this.filename = "spipa";
  this.canvas = canvas;
  document.getElementsByClassName('canvas-background')[0].appendChild(canvas);
...
window.addEventListener("resize", function () {
  var pic = this.document.getElementById("mainbackgroundcanvas");
  pic.remove();
  App.setup();
  App.draw();
